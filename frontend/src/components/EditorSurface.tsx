  ...
  return (
    <main className="flex-1">
      <div className="mx-auto w-full max-w-4xl px-4 py-6 sm:px-6 lg:max-w-3xl">
        ...
        <div className="mt-6 rounded-md border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-950">
          <label
            htmlFor="editor"
            className="sr-only"
          >
          ...
          <textarea
            id="editor"
            spellCheck={false}
            className="block h-[50vh] w-full resize-y bg-transparent p-4 font-serif text-base leading-relaxed text-gray-900 outline-none placeholder:text-gray-400 dark:text-gray-100"
